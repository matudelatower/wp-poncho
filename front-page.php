                        ...
                        <div class="col-sm-6 col-md-4">
                            <a class="panel panel-default"
                               href="http://argob.github.io/poncho/ejemplos/pagina-area.html#">
                                <div class="panel-body">
                                    <h3>Lorem ipsum dolor sit amet</h3>
                                    <p class="text-muted">quis nostrud exercitation ullamco laboris nisi ut aliquip ex
                                        ea
                                        commodo</p>
                                </div>
                            </a>
		...
		<?php if ( $seccion_noticias_activo ) { ?>
            <section>
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <a class="btn btn-primary" href="<?php echo $category_link; ?>">Ver todas las noticias</a>
                        </div>
                    </div>
                </div>
            </section>
